...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedSkills() {
        List<Skill> defaultSkills = Arrays.asList(
                ...
                new Skill(null, "UI/UX Design", "Design", "User interface and user experience wireframing, Figma prototyping"),
                new Skill(null, "Graphic Design", "Design", "Visual communication, branding, typography, Illustrator/Photoshop"),
                new Skill(null, "Public Speaking", "Business", "Presentation skills, confidence, body language, storytelling"),
                new Skill(null, "Negotiation", "Business", "Commercial negotiation, conflict resolution, active listening"),
                new Skill(null, "Project Management", "Business", "Agile methodologies, Scrum framework, timeline planning"),
                ...
                new Skill(null, "Photography", "Arts", "Camera operations, composition, lighting, Lightroom/Photoshop editing"),
                new Skill(null, "Machine Learning", "Data Science", "Supervised/unsupervised learning models, Scikit-learn, Pandas"),
                new Skill(null, "Financial Modeling", "Finance", "Excel forecasting, spreadsheet modeling, valuation models")
        );
